		...
		if(strcmp(tkn.lexeme,"(")==0)
		{
			...
			if(strcmp(tkn.lexeme,")")==0)
			{
				...
				if(strcmp(tkn.lexeme,"{")==0)
				{
					...
					{
						printf("\n} missing at row=%d col=%d\n",tkn.row,tkn.col);
						exit(1);
					}
				}
				else
				{	
					printf("\n{ missing at row=%d col=%d",tkn.row,tkn.col);
					exit(1);
				}
			}
			else
...
void datatype()
{
	...
	{
		printf("\n%s Missing datatype at row=%d col=%d",tkn.lexeme, tkn.row,tkn.col);
		exit(1);
	}
}
void idlist()
{
	...
	{
		printf("\nMissing identifier at row=%d col=%d",tkn.row,tkn.col);
		exit(0);
	}
}
void idlistprime()
